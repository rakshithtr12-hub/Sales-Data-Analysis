...
-- 9. Retrieve each product line and categorize as Good/Bad based on avg sales
...
-- Customer Analysis
-- 1. How many unique customer types?
SELECT COUNT(DISTINCT customer_type) FROM sales;

-- 2. How many unique payment methods?
...
-- 7. Which time of the day gets most ratings?
...
-- 8. Ratings per branch by time_of_day
...
-- 10. Which day has the best ratings per branch?
